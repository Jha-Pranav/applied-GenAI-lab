...
# %% auto 0
__all__ = ['RESET', 'SYSTEM_PROMPT', 'BuddyClient', 'main']
                ...
                if function_name == "fs_read" and "operations" in arguments:
                    for op in arguments["operations"]:
                        if "mode" in op:
                            ...
                            elif mode in ["List", "list", "Dir", "dir", "directory"]:
                                op["mode"] = "Directory"
                                print(f"🔧 Auto-corrected mode '{mode}' to 'Directory'")
                            elif mode in ["Find", "find", "Grep", "grep", "search"]:
                                op["mode"] = "Search"
                                print(f"🔧 Auto-corrected mode '{mode}' to 'Search'")
                            elif mode in ["tree", "Tree", "TREE"]:
                                op["mode"] = "Tree"
                                print(f"🔧 Auto-corrected mode '{mode}' to 'Tree'")
