# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/buddy/backend/tools/planning/task_monitor.ipynb.

# %% auto 0
__all__ = ['TaskMonitorTool']

# %% ../../nbs/buddy/backend/tools/planning/task_monitor.ipynb 1
"""
Task Monitor BaseTool - Tracks task execution and validates success criteria
"""
from typing import Dict, Any, List
from .base import BaseTool

class TaskMonitorTool(BaseTool):
    def __init__(self):
        super().__init__()
        self.active_tasks = {}
