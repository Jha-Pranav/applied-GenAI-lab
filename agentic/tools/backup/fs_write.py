# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/buddy/backend/tools/filesystem/backup.fs_write.ipynb.

# %% auto 0
__all__ = ['logger', 'WriteCommand', 'EditOperationType', 'FsWriteOperation', 'FsWriteParams', 'FsWriteTool']

# %% ../../../nbs/buddy/backend/tools/filesystem/backup.fs_write.ipynb 1
...
# %% ../../../nbs/buddy/backend/tools/filesystem/backup.fs_write.ipynb 2
import os
import re
import logging
import difflib
