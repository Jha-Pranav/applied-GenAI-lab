...
# %% auto 0
__all__ = ['AGENT_ROLES', 'HandoffType', 'HandoffRequest', 'HandoffResponse', 'HandoffManager', 'HandoffTool']
...
# Predefined agent roles for common handoffs
AGENT_ROLES = {
    "code_reviewer": {
        "name": "Code Reviewer",
    ...
    "data_analyst": {
        ...
        "tools": ["code_interpreter", "fs_read", "fs_write"]
    },
    "devops_engineer": {
        "name": "DevOps Engineer",
        "description": "Specialized in infrastructure and deployment",
