# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/buddy/backend/tools/fs_read.backup.ipynb.

# %% auto 0
__all__ = ['FsReadTool', 'sample_dir_structure', 'test_directory_mode_lists_files', 'test_line_mode_reads_partial_content',
...
# %% ../../nbs/buddy/backend/tools/fs_read.backup.ipynb 5
import os
import tempfile
import pytest
from pathlib import Path
